    ...
    return (
        <div className="space-y-6 h-full flex flex-col">
            <div className="flex justify-between items-center bg-muted/30 p-4 rounded-lg border">
                <div>
                    <h3 className="text-lg font-medium">Gestión de Riesgos y Simulación</h3>
                    <p className="text-sm text-muted-foreground">Análisis "What-If" para volatilidad cambiaria y probabilidad de quiebre.</p>
                </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Impacto en Valor de Reposición (USD Inventory)</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-8">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900 rounded-lg p-4 space-y-2 border">
                            ...
                            <div className={`flex justify-between text-sm font-medium ${diff > 0 ? "text-red-500" : "text-green-500"}`}>
                    ...
                    <CardContent>
                        <div className="space-y-6">
                            <p className="text-sm text-muted-foreground">
                                Este modelo estima la probabilidad de que un proveedor se retrase más allá del stock de seguridad disponible.
                            </p>

                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="font-medium">Proveedor: ACEROS AREQUIPA</span>
                                        <span className="text-red-500 font-bold">Alto Riesgo (85%)</span>
                                    </div>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="font-medium">Proveedor: CORPORACION FURUKAWA</span>
                                        <span className="text-green-500 font-bold">Bajo Riesgo (12%)</span>
                                    </div>
                                    <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-yellow-500 font-bold">Riesgo Medio (45%)</span>
                                    </div>
                                    <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden">
