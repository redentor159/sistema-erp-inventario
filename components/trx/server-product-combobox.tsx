...
export function ServerProductCombobox({ value, initialProduct, onChange, disabled }: ServerProductComboboxProps) {
    ...
    const [selectedObject, setSelectedObject] = React.useState<any>(initialProduct || null)
            ...
            <PopoverTrigger asChild>
                ...
                >
                    <span className="truncate">
                        {selectedObject ? selectedObject.nombre_completo : "Buscar producto (Enter)..."}
                    </span>
