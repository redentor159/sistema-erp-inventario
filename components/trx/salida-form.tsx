...
export function SalidaFormCmp({ onSuccess }: SalidaFormProps) {
  ...
  const { data: config } = useQuery({
    queryKey: ["mstConfig"],
    queryFn: mstApi.getConfiguracion,
  });
  ...
  const calculatePrice = (product: any, tipo: string) => {
    ...
    const margen = config ? Number(config.margen_ganancia_default) || 0.3 : 0.3;
              ...
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="DEVOLUCION_PROOVEDOR">
                      Devolución a Prov.
                    </SelectItem>
                  </SelectContent>
                </Select>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-2">
                ...
                <FormControl>
                  <Textarea
                    placeholder="Ej. Para Proyecto X, Merma, etc."
                    {...field}
                  />
                </FormControl>
                <FormMessage />
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setIncluirIgv(checked as boolean)
                  }
                />
                <label
                  htmlFor="igv"
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                append({ id_sku: "", cantidad: 1, precio_unitario: 0 })
              }
            >
                ...
                {fields.map((field, index) => (
                  <TableRow key={field.id}>
                    ...
                    <TableCell className="text-right font-medium">
                      {(
                        (form.watch(`detalles.${index}.cantidad`) || 0) *
                        (form.watch(`detalles.${index}.precio_unitario`) || 0)
                      ).toFixed(2)}
                    </TableCell>
                    <TableCell>
                      <Button
