...
export function RecipeModelList({
  selectedModelId,
  onSelectModel,
}: RecipeModelListProps) {
  ...
  const grouped = (modelos || []).reduce<Record<string, RecetaModelo[]>>(
    (acc, m) => {
      const sysName =
        m.mst_series_equivalencias?.nombre_comercial ||
        m.id_sistema ||
        "Sin Sistema";
  ...
  async function handleCloneModel() {
    ...
    try {
      await recetasApi.clonarModelo(
        cloneSource.id_modelo,
        cloneData.id_modelo,
        cloneData.nombre_comercial,
      );
      queryClient.invalidateQueries({ queryKey: ["recetaModelos"] });
  ...
  async function handleDeleteModel(modelo: RecetaModelo) {
    if (
      !confirm(
        `¿Eliminar "${modelo.nombre_comercial}" y todas sus recetas?\n\nEsta acción NO se puede deshacer.`,
      )
    )
      return;
    try {
                    ...
                    <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Button
                        ...
                        onClick={(e) => {
                          ...
                          setCloneSource(m);
                          setCloneData({
                            id_modelo: `${m.id_modelo}_COPIA`,
                            nombre_comercial: `${m.nombre_comercial} (Copia)`,
                          });
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Define el identificador y nombre del modelo de ventana/puerta.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <div className="grid gap-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewModel({
                    ...newModel,
                    id_modelo: e.target.value.toUpperCase().replace(/\s/g, "_"),
                  })
                }
            ...
            <div className="grid gap-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewModel({ ...newModel, nombre_comercial: e.target.value })
                }
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewModel({
                      ...newModel,
                      num_hojas: Number(e.target.value),
                    })
                  }
                />
              </div>
            ...
            <div className="grid gap-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewModel({ ...newModel, descripcion: e.target.value })
                }
      ...
      <Dialog open={cloneDialogOpen} onOpenChange={setCloneDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Se copiarán todas las recetas de "{cloneSource?.nombre_comercial}"
              al nuevo modelo.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
