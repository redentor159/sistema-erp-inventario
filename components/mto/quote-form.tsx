...
export function QuoteFormCmp({ onSuccess }: QuoteFormProps) {
    ...
    const subtotalNeto = detalles?.reduce((acc, curr) => {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2">
                                ...
                                <FormControl>
                                    <Input placeholder="Ej. Residencia Familia Pérez" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                        ...
                        {fields.map((field, index) => (
                            <Card key={field.id} className="relative">
                                ...
                                <CardHeader className="pb-2">
                                    <CardTitle className="text-base font-medium">#{index + 1} | Item</CardTitle>
                                </CardHeader>
                                <CardContent className="grid grid-cols-2 gap-3 text-sm">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs">Etiqueta (Ej. V-01)</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs">Modelo / Plantilla</FormLabel>
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="col-span-2">
                                                ...
                                                <FormControl>
                                                    <Input placeholder="Ej. Sala Comedor" {...field} className="h-8" />
                                                </FormControl>
                                            </FormItem>
                                        )}
                                    />
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="col-span-2">
                                                <FormLabel className="text-xs font-bold text-green-600">Precio Venta (Manual)</FormLabel>
                                                <FormControl>
                                                    <Input type="number" step="0.01" {...field} className="h-8 border-green-200 bg-green-50" />
                                                </FormControl>
                ...
                <div className="flex flex-col items-end space-y-2 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                    <div className="flex items-center space-x-2">
                        <span className="text-sm text-muted-foreground">Incluir IGV (18%)</span>
                        <FormField
                            control={form.control}
                            name="incluye_igv"
                            render={({ field }) => (
                    ...
                    <div className="flex justify-between w-64 text-xl font-bold border-t pt-2">
                        <span>Total:</span>
                        <span>{totalGeneral.toFixed(2)} {form.getValues('moneda')}</span>
                    </div>
                </div>
