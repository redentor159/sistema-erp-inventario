                    ...
                    <TabsContent value="empresa">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Información que aparecerá en el encabezado de cotizaciones y documentos
                                </CardDescription>
                            </CardHeader>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Límite de descuento para proteger márgenes (ej: 0.15 = 15%)
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Notas Adicionales (Pie de Cotización)</FormLabel>
                                            <FormControl>
                                                <Textarea
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input placeholder="Juan Pérez García" {...field} value={field.value || ""} />
                                                </FormControl>
                                                <FormDescription>
