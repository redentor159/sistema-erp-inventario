                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="CLI_XYZ" {...field} disabled={isEditing} className="h-8" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs">Nombre Completo / Razón Social</FormLabel>
                                    <FormControl>
                                        <Input placeholder="Empresa SAC..." {...field} className="h-8" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs">Dirección / Obra Principal <span className="text-muted-foreground font-normal">(Opcional)</span></FormLabel>
                                    <FormControl>
                                        <Input placeholder="Av. Principal 123..." {...field} value={field.value || ''} className="h-8" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
