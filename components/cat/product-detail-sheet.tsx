    ...
    <Sheet>
      ...
      <SheetContent className="w-[400px] sm:w-[540px] overflow-y-auto">
        <SheetHeader>
          ...
          <SheetDescription>{product.nombre_completo}</SheetDescription>
        </SheetHeader>

        <div className="mt-6 space-y-6">
          {/* STATUS CARD */}
          <div
            className={`p-4 rounded-lg border ${isNegative ? "bg-red-50 border-red-200" : "bg-green-50 border-green-200"}`}
          >
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">
                  {product.sistema_nombre || product.id_sistema || "-"}
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  {product.largo_estandar_mm
                    ? `${Number(product.largo_estandar_mm).toLocaleString()} mm`
                    : "-"}
                </p>
              </div>
              <div>
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Aquí podrías ver los últimos 5 movimientos o ir directo al Kardex
              filtrado por este SKU.
            </p>
          </div>
        </div>
      </SheetContent>
