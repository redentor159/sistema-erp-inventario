...
import { Loader2, Lock, Mail, AlertCircle, CheckCircle, ArrowLeft } from 'lucide-react'
        ...
        <div className="min-h-screen flex bg-gray-50">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-white border-r border-gray-200 flex-col items-center justify-center p-12">
                <div className="max-w-sm text-center space-y-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">ERP/WMS</h1>
                        <p className="text-gray-500 mt-2 text-sm">Sistema de Gestión para Vidriería</p>
                    </div>
                    <div className="space-y-3 text-left pt-4">
                        {['Gestión de inventario y Kardex', 'Cotizaciones y despiece automático', 'Control de producción Kanban', 'Reportes y análisis en tiempo real'].map(f => (
                    ...
                    {screen === 'login' && (
                        <>
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">Ingresa tus credenciales para acceder al sistema</p>
                            </div>
                            ...
                            <p className="text-xs text-center text-gray-400">
                                El acceso está restringido a usuarios autorizados.<br />
                    ...
                    {screen === 'forgot' && (
                        <>
                            ...
                            <form onSubmit={handleForgotPassword} className="space-y-5">
                                <div className="space-y-1">
                                    <label htmlFor="reset-email" className="text-sm font-medium text-gray-700">Correo electrónico</label>
                                    <div className="relative">
                                        <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
                                        <input
                                            id="reset-email"
                    ...
                    {screen === 'forgot-sent' && (
                        <div className="text-center space-y-6">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-xs text-gray-400">Revisa también tu carpeta de spam.</p>
                            </div>
                            <button
                                onClick={() => { setScreen('login'); setError(null) }}
