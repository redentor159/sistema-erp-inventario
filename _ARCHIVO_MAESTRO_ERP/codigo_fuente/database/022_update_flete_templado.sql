-- FIX: RESTORE LOGICA DE PRECIOS Y AGREGAR FLETE CON FACTOR
-- Basado en la version correcta que incluye formulas y actualiza cotizaciones_detalle
-- Autor: Antigravity
-- Fecha: 2026-02-20
