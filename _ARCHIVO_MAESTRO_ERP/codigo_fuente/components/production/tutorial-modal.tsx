...
export function TutorialModal({
    ...
    const steps = useMemo(() => [
        ...
        },
        {
            ...
            content: <p>El tablero está dividido en columnas que representan tu flujo de trabajo. Fíjate en el contador en el título. Si se supera el límite establecido, la columna se pondrá <strong>roja</strong> para señalar un posible cuello de botella.</p>
        },
        {
            ...
            content: <p>Cada tarjeta es una orden de trabajo. Contiene toda la información clave: ID de orden (<strong>'{safeSampleCard.id}'</strong>), cliente (<strong>'{safeSampleCard.client_name}'</strong>), y la fecha de entrega, que cambia de color según la urgencia.</p>
        },
        {
        ...
        },
        {
            ...
            content: <p>Para empezar un nuevo trabajo, simplemente haz clic en este botón. Se abrirá un formulario para que llenes los detalles.</p>
        },
        {
        ...
        },
        {
            ...
            content: <p>Usa los botones de exportación para descargar un historial completo de cada orden de trabajo que ha existido en el tablero.</p>,
            modal: 'export'
        },
        // --- Settings Module ---
        {
                ...
                <div className="flex-shrink-0">
                    <div className="flex justify-between items-start mb-4">
                        <div className="w-full">
                            <p className="text-sm font-bold text-indigo-600 dark:text-indigo-400">PASO {step + 1} de {steps.length}</p>
                            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mt-1">{currentStepData.title}</h3>
                        </div>
                        <button onClick={handleClose} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-3xl leading-none">&times;</button>
                    </div>
                </div>
