        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Ingrese la cantidad física contada. El sistema calculará la diferencia.
                    </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                    ...
                    {physicalCount !== "" && !isZeroDifference && (
                        <div className={`text-center p-2 rounded text-sm font-bold ${diff > 0 ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleSave} disabled={mutation.isPending || physicalCount === "" || isZeroDifference}>
