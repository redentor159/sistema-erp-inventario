-- =================================================================================================
-- SEED: AGREGAR NUEVA PLANTILLA VL4217 Y SUS VARIANTES
-- Fecha: 2026-03-19
--
-- Plantilla: Marco Superior Triple Carril (VL4217)
...
VALUES ('VL4217', 'Marco Superior Triple Carril', 'PERF', 'SYS_28', 6000)
...
SELECT 
    'AL-VL4217-' || a.id_finish || '-' || m.id_brand,
    'VL4217',
    m.id_brand,
    'AL', -- Material Aluminio (AL)
    a.id_finish,
    'Marco Superior Triple Carril ' || a.name_finish || ' ' || m.name_brand,
    'UND',
    'PERFILES',
...
-- 3. Verificación
-- SELECT COUNT(*) FROM cat_productos_variantes WHERE id_sku LIKE 'AL-VL4217%';
