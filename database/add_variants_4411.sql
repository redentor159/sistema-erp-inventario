-- =================================================================================================
-- SEED: AGREGAR NUEVA PLANTILLA 4411 Y SUS VARIANTES
-- Fecha: 2026-03-19
--
-- Plantilla: Contramarco de ventana Proyectante (4411)
-- Sistema: Serie 45 Muro Cortina (SYS_45)
...
VALUES ('4411', 'Contramarco de ventana Proyectante', 'PERF', 'SYS_45', 6000)
...
SELECT 
    'AL-4411-' || a.id_finish || '-' || m.id_brand,
    '4411',
    m.id_brand,
    'AL', -- Material Aluminio (AL)
    a.id_finish,
    'Contramarco de ventana Proyectante ' || a.name_finish || ' ' || m.name_brand,
    'UND',
    'PERFILES',
...
-- 3. Verificación
-- SELECT COUNT(*) FROM cat_productos_variantes WHERE id_sku LIKE 'AL-4411%';
