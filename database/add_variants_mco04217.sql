-- =================================================================================================
-- SEED: AGREGAR NUEVA PLANTILLA MCO04217 Y SUS VARIANTES
-- Fecha: 2026-03-19
--
-- Plantilla: Perfil adaptador de hoja (MCO04217)
...
VALUES ('MCO04217', 'Perfil adaptador de hoja', 'PERF', 'SYS_28', 6000)
...
SELECT 
    'AL-MCO04217-' || a.id_finish || '-' || m.id_brand,
    'MCO04217',
    m.id_brand,
    'AL', -- Material Aluminio (AL)
    a.id_finish,
    'Perfil adaptador de hoja ' || a.name_finish || ' ' || m.name_brand,
    'UND',
    'PERFILES',
...
-- 3. Verificación
-- SELECT COUNT(*) FROM cat_productos_variantes WHERE id_sku LIKE 'AL-MCO04217%';
