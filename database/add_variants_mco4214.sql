-- =================================================================================================
-- SEED: AGREGAR NUEVA PLANTILLA MCO4214 Y SUS VARIANTES
-- Fecha: 2026-03-19
--
-- Plantilla: Traslape reforzado (MCO4214)
...
VALUES ('MCO4214', 'Traslape reforzado', 'PERF', 'SYS_28', 6000)
...
SELECT 
    'AL-MCO4214-' || a.id_finish || '-' || m.id_brand,
    'MCO4214',
    m.id_brand,
    'AL', -- Material Aluminio (AL)
    a.id_finish,
    'Traslape reforzado ' || a.name_finish || ' ' || m.name_brand,
    'UND',
    'PERFILES',
...
-- 3. Verificación
-- SELECT COUNT(*) FROM cat_productos_variantes WHERE id_sku LIKE 'AL-MCO4214%';
