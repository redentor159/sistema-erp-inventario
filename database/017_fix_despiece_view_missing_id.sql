-- 017_fix_despiece_view_missing_id.sql
-- Fixes bug where Despiece Dialog shows items from other lines
-- Adds 'id_linea_cot' to the VIEW so frontend can filter correctly.
