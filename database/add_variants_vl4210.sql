-- =================================================================================================
-- SEED: AGREGAR NUEVA PLANTILLA VL4210 Y SUS VARIANTES
-- Fecha: 2026-03-19
--
-- Plantilla: Zocalo de Hoja Inferior (VL4210)
...
VALUES ('VL4210', 'Zocalo de Hoja Inferior', 'PERF', 'SYS_28', 6000)
...
SELECT 
    'AL-VL4210-' || a.id_finish || '-' || m.id_brand,
    'VL4210',
    m.id_brand,
    'AL', -- Material Aluminio (AL)
    a.id_finish,
    'Zocalo de Hoja Inferior ' || a.name_finish || ' ' || m.name_brand,
    'UND',
    'PERFILES',
...
-- 3. Verificación
-- SELECT COUNT(*) FROM cat_productos_variantes WHERE id_sku LIKE 'AL-VL4210%';
