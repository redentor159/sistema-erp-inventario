...
export const catApi = {
  ...
  createPlantilla: async (plantilla: PlantillaForm) => {
    ...
    if (clean.id_sistema === "" || clean.id_sistema === "null")
      clean.id_sistema = null;
    if (clean.id_familia === "" || clean.id_familia === "null")
      clean.id_familia = null;
  ...
  updatePlantilla: async (
    id_plantilla: string,
    plantilla: Partial<PlantillaForm>,
  ) => {
    // Clean nullable/empty fields
  ...
  updateProducto: async (
    old_sku: string,
    producto: Partial<ProductoVarianteForm>,
  ) => {
