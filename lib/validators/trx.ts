...
export const movimientoSchema = z.object({
  ...
  cantidad: z.coerce
    .number()
    .refine((val) => val !== 0, "Cantidad no puede ser 0"),
...
export const entradaCabeceraSchema = z
  .object({
...
export const salidaCabeceraSchema = z
  .object({
    tipo_salida: z.enum([
      "VENTA",
      "PRODUCCION",
